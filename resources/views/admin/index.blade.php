    ...
    <div class="profile-inner">
        <div class="profile-btns">
            ...
            <div class="addNewListing">
                <a href="{{route('admin.create')}}"><button>+ Add New Leads</button></a>
            </div>
        </div>
    ...
    <div class="leadsSectionDiv">
        <div class="leads-viewAllButton">
            <div id="leads576-createleads-div">
                ...
                <a href="{{route('admin.create')}}"><button>Create Leads</button></a>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="dropdown" id="dropdown">
                        <form style="display: flex ;justify-content: space-between ; box-shadow: none; background: none" action=/admin/leads/search/{query}"  method="get" class="">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="writeOrDelete-div">
                                ...
                                <form method="GET" style="background: none; box-shadow: none"  action="{{ route('admin.edit', ['id' => $lead->id]) }}">
                                    @csrf
...
<script>
    ...
    deleteButton.addEventListener('click',(e)=> {
        const newUrl = `/admin/leads/${currentId}`;
