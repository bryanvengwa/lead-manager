...
<form method="POST" id="form" action="{{route("agent.store")}}" >
    @csrf
...
<div class="flex-container">
    ...
    <div class="input-container flex-column col-md-6">
        <div class="error-container">
...
<div class="flex-container">
    <div class="input-container col-md-6">
        ...
        <br>
        <span>@error('email_address'){{$message}}@enderror</span>
        </div>
    ...
    <div class="input-container col-md-6">
        ...
        <input type="tel" name="contact_number_1" class="form-control" id="phone" >
...
<div class="flex-container">
    <div class="input-container col-md-6">
        ...
        <input type="tel" name="contact_number_2" class="form-control" id="phone2" >
    ...
    <div class="input-container col-md-6">
        ...
        <input type="text" name="address_1" class="form-control" id="address" >
...
<div class="benefits form"  id="form">
    ...
    <div class="flex-container">
        ...
        <div class="input-container col-sm-12">
            ...
            <input type="checkbox" name="income_based_job_seekers_allowance" class="checkbox" value="1" id="1" >

        </div>
        <div class="input-container col-sm-12">
            <label for="2">Income-related Employment and Support Allowance</label>
            <input type="checkbox" name="income_related_employment" class="checkbox" value="1" id="2" >

        </div>
        <div class="input-container col-sm-12">
            <label for="3">Income Support</label>
            <input type="checkbox" name="income_support" class="checkbox" value="1" id="3" >

        </div>
        <div class="input-container col-sm-12">
            <label for="4">Pension Credit either Savings Credit or Guarantee Credit</label>
            <input type="checkbox" name="pension_credit" class="checkbox" value="1" id="4" >

        </div>
        <div class="input-container col-sm-12">
            <label for="5">Working Tax Credit</label>
            <input type="checkbox" name="working_tax_credit" class="checkbox" value="1" id="5" >

        </div>
        <div class="input-container col-sm-12">
            <label for="6">Child Tax Credit</label>
            <input type="checkbox" name="child_tax_credit" class="checkbox" value="1" id="6" >

        </div>
        <div class="input-container col-sm-12">
            <label for="7">Universal Credit</label>
            <input type="checkbox" name="universal_credit" class="checkbox" value="1" id="7" >

        </div>
        <div class="input-container col-sm-12">
            <label for="8">Housing Benefit</label>
            <input type="checkbox" name="housing_benefit" class="checkbox" value="1" id="8" >

        </div>
        <div class="input-container col-sm-12">
            <label for="9">Child benefit where the occupants meet the below income thresholds*</label>
            <input type="checkbox" name="child_benefit_where" class="checkbox" value="1" id="9" >
...
<div action=""  class="property-information form">
    ...
    <div class="flex-container">
        ...
        <textarea name="rating_notes" id="rating_notes" class="form-control" cols="30" rows="10"></textarea>
    </div>
    <div class="flex-container flex-containers ">
        <div class="input-container col-sm-12">
            <label for="boiler_years">How old is your Boiler?</label>
            <input type="number" name="boiler_years" class="form-control" id="boiler_years" >

        </div>
        <div class="input-container col-md-6">
            <label for="boiler_model">What is the make and model of the Boiler?</label>
            <input type="text" name="boiler_model" class="form-control" id="boiler_model" >
    ...
    <div class="flex-container flex-containers">
        ...
        <div class="input-container col-md-6">
            ...
            <input type="date" name="build_year" class="form-control" id="build_year" >
    ...
    <div class="flex-container">
        ...
        <div class="input-container col-md-6">
            ...
            <textarea  id="habitable_rooms_unheated_notes" class="form-control" cols="30" rows="10"></textarea>
    ...
    <div class="flex-container flex-containers" >
        <div class="input-container col-sm-6 col-md-6">
            ...
            <input type="date" name="extension_built_date" class="form-control" id="extension_built_date" >
    ...
    <div class="flex-container flex-containers">
        <div class="input-container col-sm-12">
            ...
            <input type="date" name="RIR_built_date" class="form-control" id="RIR_built_date" >
    ...
    <div class="flex-container ">
        <div class="input-container col-md-6">
            ...
            <select type="text" name="property_wall_type" id="property_wall_type"  class="form-control" >
                ...
                <option value="no cavity">No cavities</option>
                <option value="solid brick">solid brick</option>

            </select>
        </div>
        <div class="input-container col-md-6">
            <label for="property_wall_type_notes">Property cavity notes</label>
            <textarea  id="property_wall_type_notes" name="property_wall_type_notes" class="form-control" cols="30" rows="10"></textarea>
    ...
    <div class="flex-container flex-containers">
        <div class="input-container col-sm-12">
            ...
            <select type="text" name="solar_or_ASHP" class="form-control" id="solar_or_ASHP" >
                <option value="1">yes</option>
                <option value="0">no</option>
        ...
        <div class="input-container col-md-6">
            ...
            <input type="text" name="password" class="form-control" id="Memorable password" >
